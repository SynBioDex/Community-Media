...
of genetic designs. 
%
This document details version 2.2 of SBOL Visual, which builds on the prior SBOL Visual 2.2 standard by
changing the grounding for molecular species glyphs is changed from BioPAX to SBO, which is both more expressive and aligns with interaction glyph use of SBO terms, 
by adding new glyphs for proteins, introns, and polypeptide regions (e.g., protein domains),
by deprecating the macromolecule glyph often confused with yeast, 
and by recommending small polygons as alternative glyphs for simple chemicals.
\end{abstract}
